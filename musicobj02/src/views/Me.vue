	...
	<section class="aui-scrollView">
		...
		<div class="aui-chang-list">
			<div class="aui-user-img">
				<img style="width:100%;height:100%;" src="http://p3.music.126.net/XDncptlBJ4_LN3hLBx-8aw==/19061133579343591.jpg" alt="">
			</div>
			<div class="aui-user-text">
				<h1>啦啦啦</h1>
				<span><i class="icon icon-vip"></i>您还未开通VIP</span>
				<button>开通会员</button>
			</div>
		...
		<div class="aui-palace aui-palace-one">
			<a href="javascript:;" class="aui-palace-grid">
				<div class="aui-palace-grid-icon">
					<img src="../assets/nav-001.png" alt="">
				</div>
			...
			<a href="javascript:;" class="aui-palace-grid">
				<div class="aui-palace-grid-icon">
					<img src="../assets/nav-002.png" alt="">
				</div>
				<div class="aui-palace-grid-text">
					<h2>客户管理</h2>
				</div>
			...
			<a href="javascript:;" class="aui-palace-grid">
				<div class="aui-palace-grid-icon">
					<img src="../assets/nav-003.png" alt="">
				</div>
				<div class="aui-palace-grid-text">
					<h2>任务监控</h2>
				</div>
			...
			<a href="javascript:;" class="aui-palace-grid">
				<div class="aui-palace-grid-icon">
					<img src="../assets/nav-004.png" alt="">
				</div>
				<div class="aui-palace-grid-text">
					<h2>数据统计</h2>
				</div>
		...
		<div class="aui-list-item">
			...
			<a href="javascript:;" class="aui-flex b-line">
				<div class="aui-cou-img">
					<img src="../assets/icon-004.png" alt="">
				</div>
				<div class="aui-flex-box">
					<p>退出账号</p>
				</div>
